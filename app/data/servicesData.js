...
export const services = [
    {
        icon: <Code2 className="w-5 h-5 text-text-white"/>,
    ...
    {
        icon: <Palette className="w-5 h-5 text-text-white"/>,
    ...
    {
        icon: <Search className="w-5 h-5 text-text-white"/>,
    ...
    {
        icon: <Gauge className="w-5 h-5 text-text-white"/>,
