    ...
    return (
        <div className="absolute -z-10 w-full h-full bg-black">
            <div
                ...
                style={{
                    background: 'radial-gradient(ellipse 80% 50% at 50% 0%, rgba(8, 51, 69, 0.7) 0%, transparent 70%)'
                }}
            />

            {/* Top gradient - subtle blue/teal tones */}
            <div className="absolute inset-0 bg-gradient-to-t from-transparent via-black to-cyan-950/30"/>
            ...
            <div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-amber-950/30"/>
