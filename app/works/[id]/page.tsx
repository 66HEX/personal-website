    ...
    return (
        <div>
            <div className="bg-offwhitebackground text-offblacktext">
                ...
                <div
                    className="w-full grid grid-cols-1 md:grid-cols-2 gap-8 px-4 lg:px-24 py-8 lg:py-24 text-sm leading-tight">
                ...
                <div className="w-screen pb-8 md:pb-24 px-4 lg:px-24 grid grid-cols-1 md:grid-cols-2 gap-8">
