...
export default function HeroSection() {
    return (
        <section className="w-screen px-4 lg:px-24 py-24 text-text-white relative flex items-center overflow-hidden">
            ...
            <div className="w-full flex flex-col relative  p-4 md:p-8 ">
                <div className="flex justify-end md:justify-between mb-8">
                    <div className="hidden md:block">
                        <div
                            className="px-4 py-1.5 text-sm font-[400] inline-block text-text-gray bg-white/[0.025] border border-card-border rounded-full">
